...
namespace Microwave.Test.Unit
{
    ...
    public class UserInterfaceTest
    {
        ...
        public void Setup()
        {
            ...
            minutesButton = Substitute.For<IButton>();
        ...
        public void SetTime_StartButton_CookerIsCalled()
        {
            ...
            cooker.Received(1).StartCooking(50, 60,0);
        }
        ...
        public void Ready_PowerAndTime_CookerIsCalledCorrectly()
        {
            ...
            cooker.Received(1).StartCooking(100, 120,0);
        }
        ...
        public void Ready_FullPower_CookerIsCalledCorrectly()
        {
            ...
            cooker.Received(1).StartCooking(700, 60,1);
